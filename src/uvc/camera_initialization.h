...
static unsigned char mode_1920x1080[] = {
  ...
  // Image Height:
  // crop_rect.top: 692
  // Y-Start address - 02B4
  // KRB : Amended to allow vertical binning (x2 vertical lines)
  // KRB : Old values above, new value = 152 lines (0098)
  // KRB : Tested binning, aspect ratio changes. Reverting to original numbers for standard work
  ...
  // Y-end address - (692 + 1080) - 1 = 1771 (0x06EB)
  //KRB : Amended to allow vertical binning (x2 vertical lines)
  //KRB : Old values above, new value = 2311 lines (0907)
  // KRB : Tested binning, aspect ratio changes. Reverting to original numbers for standard work
  ...
  // Binning Mode: Y (1)
  //KRB : Amended to change to Binning mode 1 - x2 vertical
  //KRB : Changing back to no binning due to aspect ratio change
